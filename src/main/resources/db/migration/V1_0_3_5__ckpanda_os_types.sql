...
CREATE TABLE `os_types` (
  ...
  `oscategory_id` bigint(20) DEFAULT NULL,
  `updated_user_id` bigint(20) DEFAULT NULL,
  `updated_date_time` datetime DEFAULT NULL,
  `uuid` varchar(255) DEFAULT NULL,
  `version` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_co9ilookvb3s5dtgmpqb9kkdr` (`oscategory_id`),
  CONSTRAINT `FK_co9ilookvb3s5dtgmpqb9kkdr` FOREIGN KEY (`oscategory_id`) REFERENCES `os_categories` (`id`)

                    ...
                    <table width="540" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:38px 30px 30px 30px;background-color:#fafafa">
                                ...
                                <table>
                                    <tbody><tr>
                                        <td>
                                            ...
                                            <img src="https://dmx246cm6p7k8.cloudfront.net/content/images/emailer/success-icon.png" alt="" title="Your Recharge was Successful" class="CToWUd">
                                        </td>
                                        <td style="font-size:18px;font-family:Arial,Helvetica,sans-serif;color:#34495e">

                                                                                                                                               Your Invoice payment for <span>CNY. ${payment.totalFee}</span> is done!
                                                                                                                                    </td>
                                    </tr>
                                </tbody></table>
                            </td>
                        ...
                        <tr>
                            <td colspan="2" height="24">
                        	                        ...
                        	                        <tr>
	                            <td colspan="2">
                                        <div class="pull-left">Transaction ID : <span>${payment.transactionId}</span> </div>
	                            </td>
	                        </tr>
	                        <tr>
	                            <td colspan="2" height="24">
                                        <div class="pull-right">Transaction Status  : <span>${payment.tradeStatus}</span></div>
	                            </td>
	                        </tr>
	                        <tr>
                            <td colspan="2" height="24">

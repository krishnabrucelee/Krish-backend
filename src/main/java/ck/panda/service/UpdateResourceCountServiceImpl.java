...
public class UpdateResourceCountServiceImpl implements UpdateResourceCountService {
     ...
     * @param resourceType of the resource
     * @param updateResourceCount of the department
     * @param status of the department
     ...
     * @param resourceType of the resource
     * @param updateResourceCount of the project
     ...
     *
     * @param accountTypeId of the resource
     * @param accountType of the resource
     * @param resources
     * @param resourceUsageMap
     * @param updateResponse of the resource
     * @param status of the resource
     * @throws Exception if error occurs
     */

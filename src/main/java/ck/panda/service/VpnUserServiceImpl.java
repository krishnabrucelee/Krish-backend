            ...
            try {
                ...
                if (jobId.has(CloudStackConstants.CS_JOB_ID)) {
                    ...
                    if (jobresults.getString(CloudStackConstants.CS_JOB_STATUS).equals(CloudStackConstants.SUCCEEDED_JOB_STATUS)) {
                        ...
                        errors = validator.sendGlobalError(jobresults.getString(CloudStackConstants.CS_ERROR_TEXT));
                        if (errors.hasErrors()) {
                            throw new BadCredentialsException(jobresults.getString(CloudStackConstants.CS_ERROR_TEXT));
                        }
                    }
                }

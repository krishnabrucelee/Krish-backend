...
public class CloudStackHostService {
    ...
    public String findHostsForMigration(String virtualMachineid, String response) throws Exception {
        ...
        LinkedList<NameValuePair> arguments = server.getDefaultQuery("findHostsForMigration", null);
     ...
     * @throws Exception unhandled errors
     */
    public String listHosts(String response, HashMap<String, String> optional) throws Exception {

        LinkedList<NameValuePair> arguments = server.getDefaultQuery("listHosts", optional);
        arguments.add(new NameValuePair("response", response));

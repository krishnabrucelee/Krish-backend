...
public class EgressRule {
    ...
    /** IpAdress of the Egress Rule. */
    @JoinColumn(name = "ipadress_id", referencedColumnName = "Id", updatable = false, insertable = false)
    @ManyToOne
    private IpAddress ipAdress;

    /** IpAdress id of the Egress rule. */
    @Column(name = "ipadress_id")
    private Long ipAdressId;
    ...
    /**
     * Get  the ipAdress of the Egress rule.
     *
     * @return the ipAdress
     */
    ...
    /**
     * Set  the ipAdress of the Egress rule.
     *
     * @param ipAdress to set
     */
    public void setIpAdress(IpAddress ipAdress) {
        this.ipAdress = ipAdress;
    }

    /**
     * Get the ipAdressId of the Egress rule
     *
     * @return the ipAdressId
     */
    public Long getIpAdressId() {
        return ipAdressId;
    }

    /**
     * Set the ipAdressId of the Egress rule.
     *
     * @param ipAdressId to set
     */
    public void setIpAdressId(Long ipAdressId) {
        this.ipAdressId = ipAdressId;
    }

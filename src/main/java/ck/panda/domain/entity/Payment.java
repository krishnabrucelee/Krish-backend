...
/**
 * The AliPay real-time international payment solution enables merchants to
 * trade in China. Customers who are registered AliPay account holders can
 * select AliPay as their payment method on the merchant web site
 *
 */
@Entity

...
public interface ApplicationRepository extends PagingAndSortingRepository<Application, Long> {
     ...
     * @return list of applications
     */
    @Query(value = "SELECT app FROM Application app WHERE (app.domainId=:domainId OR 0 = :domainId) AND app.isActive = :isActive AND (app.type LIKE %:search% OR app.description LIKE %:search% OR app.domain.name LIKE %:search% )")

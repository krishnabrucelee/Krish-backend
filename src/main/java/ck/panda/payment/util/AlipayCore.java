...
public class AlipayCore {
     ...
     *
     * @param sArray signature parameter set
    ...
    /**
     * Sort the array of all elements , and in accordance with "parameter = parameter value " model with "&" character
     * to a string splicing.
     *
     * @param params need to sort and group participation character stitching parameters
    ...
    /**
     * Write the log, convenient test ( see the website needs to be changed to the record stored in the database ).
     *
     * @param sWord be written log of text
     */
     ...
     * @param file_digest_type digest algorithm

...
public class AlipaySubmit {
     ...
     *
     * @param sPara Array to be signed.
     ...
     *
     * @param sParaTemp Before the request parameter array
     ...
     *
     * @param sParaTemp Request parameter array
     * @param strMethod Submission . Optional two values ​​: post, get
     * @param strButtonName Confirmation button display text
    ...
    /**
     * Handler for anti-phishing , call interface query_timestamp to get timestamp Note : The remote XML parsing error ,
     * and the server is configured to support SSL and other relevant
     *

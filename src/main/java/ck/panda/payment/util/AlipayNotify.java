...
/**
 * Class name : AlipayNotify Function: Alipay notification processing class
 * Details: Alipay each interface processing returns notice Version: 3.3 Date:
 * 2012-08-17 Description : The following code is sample code to test for the
 * convenience of business and provided businesses as needed for your site,
 * according to technical writing , not have to use the code. The code for study
 * and research Alipay interface , only provide a reference
 */
@Component
public class AlipayNotify {
	 ...
	 *
	 * @param Params
	 *            notice to return an array of parameters
	 ...
	 *
	 * @param Params
	 *            notification returned to the array of arguments
	 * @param Sign
	 *            signature result comparison of
	 ...
	 *
	 * @param Notify_id
	 *            notification check ID
	 * @return Server ATN results Verify the result set : Invalid command
	 *         parameter does not appear this error , please check the return
	 *         process and key partner is empty True returns the correct
	 *         information False Check the firewall or the server port to
	 *         prevent problems and to verify whether the time over one minute
	 */
